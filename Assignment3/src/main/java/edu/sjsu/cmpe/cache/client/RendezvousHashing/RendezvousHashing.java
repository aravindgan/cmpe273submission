...
public class RendezvousHashing<K, N> {
	...
	/**
	 * Creates a new RendezvousHashing with a starting set of nodes provided by init. The funnels will be used when generating the hash that combines the nodes and
