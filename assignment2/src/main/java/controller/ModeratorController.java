...
public class ModeratorController {
    ...
    public @ResponseBody ResponseEntity<Moderator> moderator(@PathVariable("moderator_id") Integer id,@RequestHeader (value="Authorization") String authentication1)throws UnsupportedEncodingException {
        boolean isLogin = checkAuthentication(authentication1);
        if (isLogin) {
